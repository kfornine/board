			 ...
			 <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                	<ul class="nav" id="side-menu">
	 				...
	 				<c:forEach items="${sessionScope.menu}" var="topMenu">
...
<!--             <div class="navbar-default sidebar" role="navigation">
                ...
                왼쪽메뉴 네비게이션
                    ...
                    상위메뉴 
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i> 대메뉴1</a>
                        </li>
                        하위메뉴가 있는 경우 대메뉴를 클릭시 하위 메뉴를 보여준다
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 대메뉴2<span class="fa arrow"></span></a>
                            하위메뉴 --
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">소메뉴1</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level
                        </li>
